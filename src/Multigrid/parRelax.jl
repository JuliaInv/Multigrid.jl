...
function applyHybridKaczmarz(param::hybridKaczmarz{Float64,Int64},AT::SparseMatrixCSC{Float64,Int64},r::Array{Float64},x::Array{Float64},numDomains)
	ccall((:applyHybridKaczmarz_FP64_INT64,parRelax_lib),Nothing,(Ptr{Int64},Ptr{Float64},Ptr{Int64},Int64,Int64,Ptr{ArrIdxsType},Ptr{Float64},Ptr{Float64},Ptr{Float64},Int64,Int64,),
...
function applyHybridKaczmarz(param::hybridKaczmarz{Float32,Int64},AT::SparseMatrixCSC{Float32,Int64},r::Array{Float32},x::Array{Float32},numDomains)
	ccall((:applyHybridKaczmarz_FP32_INT64,parRelax_lib),Nothing,(Ptr{Int64},Ptr{Float32},Ptr{Int64},Int64,Int64,Ptr{ArrIdxsType},Ptr{Float32},Ptr{Float32},Ptr{Float32},Int64,Int64,),
		AT.colptr,AT.nzval,AT.rowval,numDomains,size(param.ArrIdxs,1),param.ArrIdxs,x,r,param.invDiag,param.numit,param.numCores);
end
...
function applyHybridKaczmarz(param::hybridKaczmarz{ComplexF64,Int64},AT::SparseMatrixCSC{ComplexF64,Int64},r::Array{ComplexF64},x::Array{ComplexF64},numDomains)
	ccall((:applyHybridKaczmarz_CFP64_INT64,parRelax_lib),Nothing,(Ptr{Int64},Ptr{ComplexF64},Ptr{Int64},Int64,Int64,Ptr{ArrIdxsType},Ptr{ComplexF64},Ptr{ComplexF64},Ptr{ComplexF64},Int64,Int64,),
		AT.colptr,AT.nzval,AT.rowval,numDomains,size(param.ArrIdxs,1),param.ArrIdxs,x,r,param.invDiag,param.numit,param.numCores);
end
...
function applyHybridKaczmarz(param::hybridKaczmarz{ComplexF32,Int64},AT::SparseMatrixCSC{ComplexF32,Int64},r::Array{ComplexF32},x::Array{ComplexF32},numDomains)
	ccall((:applyHybridKaczmarz_CFP32_INT64,parRelax_lib),Nothing,(Ptr{Int64},Ptr{ComplexF32},Ptr{Int64},Int64,Int64,Ptr{ArrIdxsType},Ptr{ComplexF32},Ptr{ComplexF32},Ptr{ComplexF32},Int64,Int64,),
		AT.colptr,AT.nzval,AT.rowval,numDomains,size(param.ArrIdxs,1),param.ArrIdxs,x,r,param.invDiag,param.numit,param.numCores);
end
