...
#define GET_FUNC(T,S) TOKENPASTE(applyHybridKaczmarz_, T, S)

void GET_FUNC(ValName,IndName)(spIndType *rowptr , spValType *valA ,spIndType *colA, long long numDomains, long long domainLength ,
